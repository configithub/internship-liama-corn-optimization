...
class Calculs
{
       ...
       double Wmaximal; // quantité totale d'eau à ne pas dépasser
       ...
       vec pena; // vecteur de pénalisation
       ...
       // Programme regroupant toutes les étapes nécessaire à la création du gradient
